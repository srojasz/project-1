...
function App() {
  ...
  const englishTexts = {
    starterText:
      "Hi! My name is Sara Rojas and I am a junior Front-end developer eager to work and continue learning about JavaScript, React, HTML and CSS. If you are looking for a profile like this, I suggest you a game to see if we can match : you just have to shuffle the cards and click on them.",
    secondaryText:
